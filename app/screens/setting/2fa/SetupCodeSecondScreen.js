...
export default class SetupCodeSecondScreen extends Component {
  ...
  _handleNext = () => {
    ...
    navigation.navigate('SetupCodeLastScreen');
  }

  render() {
    const textGuide = I18n.t('setting2fa.manuallyEnterYourAccount');
    return (
