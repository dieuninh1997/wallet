export default {
  ...
  landing: {
    coinName: 'Mango Coin',
    coinDescription: 'Gawing maganda ang kinabukasan',
  ...
  createWalletByEmailScreen: {
    ...
    emailInvalid: 'Ang email ay hindi wasto',
  ...
  setting: {
    ...
    perferences: 'Mga kagustuhan o pagpipilian',
    ...
    useFaceIdAsPin: 'Gumamit ang Face Id bilang PIN',
    swipeToReceive: 'Mag-swipe upang makatanggap',
    verified: 'Patunayan',
    unverified: 'Hindi napatunayan',
    disabled: 'Disabled',
    enabled: 'Enabled',
    unconfirmed: 'Hindi na kumpirma',
    usDollar: 'U.S Dollar ($)',
  ...
  transactions: {
    title: 'Transaksyon',
    noTransactionAvailable: 'Walang magagamit na rekord ng transaksyon.',
  },
  changePassword: {
  ...
  restoreWalletScreen: {
    ...
    titleForm: 'Ilagay ng labing dalawang salita na magsisilbing proteksyon  para maibalik ang iyong pondo at mga transaksyon',
