export default {
  ...
  backupPassphrase: {
    ...
    notePass: 'Please save these words in order. These words will allow you to recover your wallet.',
    important: 'Do not share it or use it on a malicious/phishing site.\nMake a paper and soft backup.',
    btnCopy: 'Kopiaen',
    btnNext: 'Sumaruno',
  ...
  PassportNumberVerifyScreen: {
    ...
    continue: 'Continue',
    messengerPassport: 'Please enter ID number number',
